...
var JSONNestedNode = (_dec = _reactMixin2.default.decorate(_mixins.ExpandedStateHandlerMixin), _dec(_class = (_temp = _class2 = function (_React$Component) {
  ...
  function JSONNestedNode(props) {
    ...
    var shouldExpandNode = _this.props.shouldExpandNode ? _this.props.shouldExpandNode(_this.props.keyName, _this.props.data, _this.props.level) : false;
    _this.state = {
      expanded: _this.props.initialExpanded || _this.props.allExpanded || shouldExpandNode,
  ...
  JSONNestedNode.prototype.render = function render() {
    ...
    var renderedChildren = expanded ? getChildNodes((0, _extends3.default)({}, this.props, { level: this.props.level + 1 })) : null;
