...
class AboutPage extends React.Component {
  render() {
    return (
      <Main>
        <Hero type="image" src={`/static/images/organizations/hope.jpg`}/>

        <div className="content-wrapper content-about">
          <div className="content-wrapper">
            <h1> Conquering Homelessness is a Shared Responsibility </h1>
            <p>&nbsp;</p>
            <p> Miami' s ascension as a world - class business hub is not only measured by the health of our real estate, financial and entrepreneurial sectors, but also by how we as a community coalesce to address critical issues that impact all of our residents.One of these critical issues our community faces is homelessness, and how we address the lack of housing options available to those that are living on the street and in shelters. </p>
            ...
            In order
            for us to achieve and maintain vibrancy, Miami - Dade' s business leaders should embrace the“ shared value” concept, upholding the ability for businesses to generate economic value that also produces value
